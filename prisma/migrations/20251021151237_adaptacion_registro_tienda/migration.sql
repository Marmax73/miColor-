/*
  ...
  - You are about to drop the column `numeroDeMobil` on the `User` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."User" DROP COLUMN "numeroDeMobil",
